-- Business Data - phpMyAdmin Compatible Version
-- For use with phpMyAdmin import
...
('Anjali Verma', 5, 'Amazing Arabic mehndi designs! The bold patterns were exactly what I wanted for my sister\'s sangeet. Quick application and beautiful results. Will definitely book again for future events.', 'Sangeet', 1, 1, 2),
...
('Top 10 Bridal Mehndi Designs for 2026', 'top-10-bridal-mehndi-designs-2026', 'Discover the most trending bridal mehndi designs for 2026. From traditional Rajasthani patterns to modern fusion styles, find the perfect design for your special day.', '<h2>Introduction</h2><p>Bridal mehndi is an essential part of Indian weddings.</p>', 'Bridal', JSON_ARRAY('bridal mehndi', 'wedding mehndi', 'mehndi designs', '2026 trends'), 'Top 10 Bridal Mehndi Designs for 2026', 'Discover trending bridal mehndi designs for 2026', 'Shiv Kumar', 1, '2026-04-01 10:00:00'),

('How to Care for Your Mehndi', 'mehndi-care-tips-long-lasting-color', 'Learn the best practices to maintain your mehndi and achieve deep, long-lasting color.', '<h2>Introduction</h2><p>Proper care ensures your mehndi develops a deep, rich color.</p>', 'Tips & Care', JSON_ARRAY('mehndi care', 'henna tips', 'long lasting mehndi'), 'Mehndi Care Tips for Long-Lasting Color', 'Learn expert tips for mehndi care and maintenance', 'Shiv Kumar', 1, '2026-04-10 14:30:00'),

('Arabic vs Traditional Mehndi', 'arabic-vs-traditional-mehndi-style-guide', 'Confused between Arabic and traditional mehndi styles? This guide helps you choose the perfect design.', '<h2>Introduction</h2><p>Both styles have their unique beauty and charm.</p>', 'Design Guide', JSON_ARRAY('arabic mehndi', 'traditional mehndi', 'mehndi styles'), 'Arabic vs Traditional Mehndi Style Guide', 'Compare Arabic and traditional mehndi styles', 'Shiv Kumar', 1, '2026-04-15 11:00:00');
